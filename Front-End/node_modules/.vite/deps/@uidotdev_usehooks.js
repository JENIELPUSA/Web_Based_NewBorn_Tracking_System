...
function useHover() {
  ...
  const customRef = React.useCallback(
    (node) => {
      var _a;
      if (((_a = previousNode.current) == null ? void 0 : _a.nodeType) === Node.ELEMENT_NODE) {
...
function useMouse() {
  ...
  React.useLayoutEffect(() => {
    const handleMouseMove = (event) => {
      ...
      if (((_a = ref.current) == null ? void 0 : _a.nodeType) === Node.ELEMENT_NODE) {
...
var getConnection = () => {
  return (navigator == null ? void 0 : navigator.connection) || (navigator == null ? void 0 : navigator.mozConnection) || (navigator == null ? void 0 : navigator.webkitConnection);
};
...
function useOrientation() {
  ...
  React.useLayoutEffect(() => {
    ...
    if ((_a = window.screen) == null ? void 0 : _a.orientation) {
      handleChange();
    ...
    return () => {
      var _a2;
      if ((_a2 = window.screen) == null ? void 0 : _a2.orientation) {
...
function useScript(src, options = {}) {
  ...
  React.useEffect(() => {
    ...
    const domStatus = script == null ? void 0 : script.getAttribute("data-status");
    if (domStatus) {
      setStatus(domStatus);
      return;
    }
