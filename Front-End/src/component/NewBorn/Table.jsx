...
import AddNewBornForm from "../VaccineRecord/AddForm"; // <- AYUSIN ITO KUNG MALI (check if this is correct form)
...
function NewBorn() {
    ...
    return (
        <div className="rounded-lg bg-white shadow dark:bg-gray-900 xs:p-2 sm:p-6">
            <div className="card-header flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-4">
                ...
                <div className="flex flex-wrap items-center gap-4 w-full md:w-auto">
                    ...
                    <input
                        ...
                        className="input input-sm flex-grow rounded-md border border-gray-300 px-3 py-1 text-sm bg-white text-gray-800 dark:bg-slate-800 dark:text-gray-200 min-w-[180px] md:min-w-0"
                        value={searchTerm}
                        onChange={(e) => {
                    ...
                    <div className="flex flex-wrap items-center gap-2 flex-grow-0">
                        ...
                        <input
                            ...
                            className="input input-xs rounded-md border border-gray-300 px-2 py-1 text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white w-32 sm:w-auto"
                                ...
                                {currentUsers.length === 0 ? (
                                    ...
                                    currentUsers.map((newBorn, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 align-top text-gray-800 dark:text-gray-200">{formatDate(newBorn.dateOfBirth)}</td>
            ...
            {/* Pagination */}
            {totalPages > 0 && (
                <div className="flex flex-col sm:flex-row items-center justify-between px-4 py-3 border-t dark:border-gray-700 gap-3">
                    <button
