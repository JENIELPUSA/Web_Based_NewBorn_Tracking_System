...
            >
                <h2 className="mb-6 text-center text-2xl font-bold text-gray-800">Update Vaccine Batch</h2>
                {error && <div className="mb-4 rounded-lg bg-red-100 p-4 text-sm text-red-700">{error}</div>}

                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Batch Selection Dropdown */}
                    <div className="relative w-full">
                        <label className="mb-1 block text-sm text-slate-600">Select Batch</label>
                        <div
...
                    <div>
                        <label className="mb-1 block text-sm text-slate-600">Expiration Date</label>
                        <input
                            type="date"
                            name="expirationDate"
...
                    <div>
                        <label className="mb-1 block text-sm text-slate-600">Brand Name</label>
                        <input
                            type="text"
...
                    <div>
                        <label className="mb-1 block text-sm text-slate-600">Stock</label>
                        <input
                            type="number"
                            name="stock"
