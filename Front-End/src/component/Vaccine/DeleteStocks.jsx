...
            >
                <h2 className="mb-6 text-center text-2xl font-bold text-gray-800">Delete Vaccine Batch</h2>
...
                    <div>
                        <label htmlFor="selectedBatch" className="block text-sm font-medium text-gray-700">
                            Select Batch
                        </label>
                        <select
                            id="selectedBatch"
...
                            readOnly
                            className="w-full cursor-not-allowed rounded-lg border border-gray-300 bg-gray-50 p-2.5 focus:border-blue-500 focus:ring-blue-500"
                        />
                    </div>
