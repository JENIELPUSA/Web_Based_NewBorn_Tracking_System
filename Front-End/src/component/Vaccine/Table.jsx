...
    return (
        <div className="card m-4 rounded-lg bg-white shadow xs:p-2 sm:p-6">
            <div className="card-header mb-2 flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-between">
                <p className="card-title text-center text-xl font-semibold text-gray-900 sm:text-left">Vaccine List</p>
...
                            className="input input-sm w-64 rounded-md border px-3 py-1 text-sm font-light text-gray-500"
                            value={searchTerm}
                            onChange={(e) => {
...
                        <label
                            htmlFor="dateFrom"
                            className="text-sm font-medium text-gray-700 text-gray-500"
                        >
                            From:
                        </label>
                        <input
...
                                setCurrentPage(1);
                            }}
                            className="input input-xs w-32 rounded-md border border-gray-300 px-2 py-1 text-sm sm:w-auto text-gray-500"
...
                            className="input input-xs w-20 rounded-md border border-gray-300 px-2 py-1 text-sm text-gray-500"
...
                        <span className="text-sm text-gray-700">vaccines per page</span>
                    </div>
                </div>
            </div>
...
                        {currentVaccines.length === 0 ? (
                            <div className="p-4 text-center text-gray-500">No vaccines found.</div>
                        ) : (
                            currentVaccines.map((item) => (
                                <div
                                    key={item._id}
                                    className="rounded-md border bg-white p-4 shadow-sm border-gray-200"
                                >
...
                {totalPages > 0 && (
                    <div className="flex flex-col items-center justify-between gap-3 border-t px-4 py-3 text-sm text-gray-700 sm:flex-row">
                        <button
