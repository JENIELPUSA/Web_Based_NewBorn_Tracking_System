...
const Card = () => {
    ...
    const { Totalbaby, TotalMale, TotalFemale } = useContext(NewBornDisplayContext);
    ...
    const cards = [
        ...
        { title: "New Born", value: "20", percentage: "2%", icon: Baby },
        { title: "Total Vaccine", 
          value: totalVaccine, 
    ...
    const BHWcards = [
        { title: "Total Vaccinated Babies", value: "15,400", percentage: "+15%", icon: Syringe },
        { title: "New Born", value: "3", percentage: "+2%", icon: CalendarCheck },
