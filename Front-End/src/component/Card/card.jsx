...
const BHWcards = [
  { title: "Total Vaccinated Babies", value: "15,400", percentage: "+15%" },
  { title: "Incoming Schedules", value: "3", percentage: "+2%" },
  { title: "Monthly Vaccinated", value: "8,300", percentage: "+10%" },
  { title: "Total Vaccines Available", value: "18,700", percentage: "+18%" },
];
...
return role === "Admin" ? (
  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    {cards.map((card, index) => (
      <div
        key={index}
        className="card bg-white dark:bg-slate-900 border rounded-lg shadow-md p-4 transition-all"
      >
        <div className="flex items-center justify-between">
          ...
          <p className="card-title font-medium text-lg text-slate-800 dark:text-slate-200">
            {card.title}
          </p>
        </div>
