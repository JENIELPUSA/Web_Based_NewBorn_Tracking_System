...
const DisplayVaccine = ({ isOpen, onClose, newbornID }) => {
    ...
    return (
        ...
        >
            <motion.div
                className="relative max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-800"
            ...
            >
                <button
                    className="absolute right-3 top-3 text-xl text-gray-500 transition-all duration-200 hover:scale-110 hover:text-red-500 dark:text-gray-300 dark:hover:text-red-400"
                    onClick={onClose}
                >
                    ...
                    {filteredData.length > 0 ? (
                        filteredData.map((vaccine, index) => (
                            <motion.div
                                ...
                                className="relative rounded-lg border border-gray-300 p-4 shadow-md transition-all duration-200 hover:shadow-lg dark:border-slate-700 dark:bg-slate-700/90 dark:hover:bg-slate-700"
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        {index < filteredData.length - 1 && <div className="my-1 h-6 w-[2px] bg-gray-300 dark:bg-slate-600" />}
                                    </div>

                                    {/* Vaccine Info */}
                                    <div className="flex-1">
                                        <h3 className="text-lg font-semibold text-gray-800 transition-colors duration-200 hover:text-blue-600 dark:text-white dark:hover:text-blue-400">
                                            {vaccine.vaccineName}
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-slate-300">{vaccine.description}</p>

                                        <div className="mt-2 flex flex-wrap gap-4 text-sm text-gray-700 dark:text-slate-200">
                                            <span className="transition-colors duration-200 hover:text-blue-600 dark:hover:text-blue-400">
                                            ...
                                            <span
                                                className={`font-medium ${
                                                    vaccine.status === "Completed"
                                                        ...
                                                        : vaccine.status === "Overdose"
                                                        ? "text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" // Overdose status
                                    ...
                                    <div className="flex gap-2 pt-1">
                                        <motion.button
                                            ...
                                            className="rounded bg-blue-500 px-2 py-1 text-white transition-colors duration-200 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700"
                                        >
                                        ...
                                        <motion.button
                                            ...
                                            className="rounded bg-red-500 px-2 py-1 text-white transition-colors duration-200 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700"
                                        >
