...
function AddNewForm({ isOpen, onClose, onSubmit, record, newbordID, editDose, editData, idBorn }) {
    ...
    const { AddAssignedVaccine, UpdateAssign } = useContext(VaccinePerContext);
    ...
    const handleSubmit = async (e) => {
        ...
        if (editData) {
            ...
            await UpdateAssign(editData,formData)
                ...
                >
                    ...
                    <div className="relative w-full">
                        ...
                        {editDose ? (
                            ...
                            <>
                                <div
                                    className="flex w-full cursor-pointer items-center justify-between rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 hover:border-slate-400 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200"
